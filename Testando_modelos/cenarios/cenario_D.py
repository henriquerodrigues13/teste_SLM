...
def cenario_d_gguf(llm, modelo):
    mensagens = [
        ...
        {"role": "user", "content": f"""
            ...
            **Exemplos de questões existentes para esta habilidade (mantenha consistência de estilo):**
            ...
            Gere 1 questão(ões) novas, inéditas e alinhadas à habilidade EF08MA05{sufixo_no_think(modelo)}
            """}
    ]
    ...
    mensagens = [
        ...
        **Exemplos de questões existentes para esta habilidade (mantenha consistência de estilo):**
        ...
        Gere 1 questão(ões) novas, inéditas e alinhadas à habilidade EF06MA17{sufixo_no_think(modelo)}
        """}
    ]
